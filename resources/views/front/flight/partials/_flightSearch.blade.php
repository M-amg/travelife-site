    ...
    <div class="container py-1">
        ...
        <div class="row" style="margin-top: 5px">
            <div class="form-group col-md col-sm-12 pl-1 p-0">
                <i class="fas fa-plane-departure" style="position: absolute; top: 17px; left: 16px; color: rgb(40 53 108 / 80%); z-index: 100;"></i>
            ...
            <div class="form-group col-md col-sm-12 pl-1 p-0">
                <i class="fas fa-plane-arrival" style="position: absolute; top: 17px; left: 16px; color: rgb(40 53 108 / 80%); z-index: 100;"></i>
