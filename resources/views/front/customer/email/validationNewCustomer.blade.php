                                                            ...
                                                            <tr>
                                                                <td align="center" width="100%"
                                                                    ...
                                                                    <h3 style="font-weight: 600; padding: 0px; margin: 0px; font-size: 16px; line-height: 24px; text-align: center;"
                                                                        class="title-color">
                                                                        Cher(e) {{$lastName}} {{$firstName}},</h3>
                                                                    <p style="margin: 20px 0 30px 0;font-size: 15px;text-align: center;">
                                                                        Validez votre e-mail en cliquant sur le lien suivant</p>
                                                                    <div style="font-weight: 200; text-align: center; margin: 25px;">
                                                                        <a href="{{route('customer.verification',['token'=>$email_token])}}"
                                                                           style="padding:0.6em 1em;border-radius:600px;color:#ffffff;font-size:14px;text-decoration:none;font-weight:bold"
                                                                           class="button-color">Confirmez votre
                                                                            compte</a>
                                                                    </div>
                                                                    <p>Suite à votre demande, nous vous informons que votre login et mot de passe ont été bien enregistrés
                                                                        sur notre plateforme "{{$agency->name}}".</p>
                                                                    <p>Nous vous rappelons que vous êtes seule à detenir ce code, et que vous êtes responsable des actions
                                                                        effectuées par ce login.</p>
                                                                    <p>Toute communication de ce code reste sous votre seule responsabilité.
                                                                        Nous vous remercions de votre confiance.</p>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
