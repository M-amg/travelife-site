                                                            ...
                                                            <tr>
                                                                <td align="center" width="100%"
                                                                    ...
                                                                    <div id=":m9" class="a3s aXjCH ">
                                                                        @lang('generate.fullName'): {{$fullname}},<br><br>
                                                                        E-mail: <a href="mailto:{{$email}}"
                                                                        target="_blank">{{$email}}</a><br><br>
                                                                        @lang('generate.phone'): {{$tel}}<br><br>
                                                                        @lang('generate.durationDays'): {{$duree}}<br><br>
                                                                        @lang('generate.nbAdult')(s): {{$adults}}<br><br>
                                                                        @lang('generate.nbChild')(s): {{$childs}}<br><br>
                                                ...
                                                <tr>
                                                    <td align="center" valign="middle" width="100%"
                                                        ...
                                                        <p>
                                                            ...
                                                            <span><a href="{{ $agency->domain_name }}">{{ $agency->domain_name }}</a> &copy; 2022 </span>
                                                        </p>
                                                    </td>
                                                </tr>
                                                </tbody>
