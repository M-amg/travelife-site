                                                                ...
                                                                <td align="center" width="100%">
                                                                    @if($book->status==1)
                                                                        <h1 style="padding:0;margin:0;color:#ffffff;font-weight:500;font-size:20px;line-height:24px">
                                                                            Une réservation a été confirmée</h1>
                                                                    @else
                                                                        <h1 style="padding:0;margin:0;color:#ffffff;font-weight:500;font-size:20px;line-height:24px">
                                                                                Vous avez reçu une nouvelle demande de réservation</h1>
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                            ...
                                                            <tr>
                                                                <td align="center" width="100%"
                                                                    ...
                                                                    <p style="margin: 20px 0 30px 0;font-size: 15px;text-align: center;">
                                                                        Voici toutes les informations concernant cette réservation :
                                                                    </p>
                                                                    <table class="table table-bordered">
                                                                        ...
                                                                        <tr>
                                                                            <td class="table-label color-grey">Nom et Prénom :</td>
                                                                            <td class="table-label color-dark-2">
                                                                        ...
                                                                        <tr>
                                                                            <td class="table-label color-grey">Tél :</td>
                                                                            <td class="table-label color-dark-2">
                                                                            ...
                                                                            <tr>
                                                                                <td align="center" style="padding:0 0 8px 0" width="100%">
                                                                                    <a href="https://manage.jambotours.com/manage/booking/booking/{{$commandLine->id}}"
                                                                                        ...
                                                                                        class="button-color">Consulter la réservation</a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
