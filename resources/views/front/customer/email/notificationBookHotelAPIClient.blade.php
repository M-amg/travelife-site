                                                                        ...
                                                                        @if($book->status==1)
                                                                            <tr>
                                                                                <td class="table-label">
                                                                                    <a href="{{route('front.hotelApi.EmailVoucher',['id'=>$bookID,'token'=>$customer->email_token])}}"
                                                                                ...
                                                                                <td class="table-label">
                                                                                    <a href="{{route('front.hotelApi.EmailBill',['id'=>$bookID,'token'=>$customer->email_token])}}"
                                                                                       style="text-align:center;padding:0.6em 1em;border-radius:600px;color:#ffffff;font-size:14px;text-decoration:none;font-weight:bold"
