...
@section('body')
    ...
    <div id="user-new-compte" class="container mt-5">
        <div class="row">
            <div class="col-md-6">
                <p class="jBlue mt-5">Si vous avez oublié votre mot de passe, vous pouvez le réinitialiser ici.</p>
                <div class="new-compte my-4">
                    <form class="f-login-form" method="POST" action="{{ route('customer.postEmail') }}"  id="Frm_reset">
                        @csrf
