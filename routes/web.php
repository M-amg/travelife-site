...
Route::get('/transfert', 'HomeController@transfert')->name('transfert');

Route::get('/contact', 'HomeController@contact')->name('contact');
Route::get('/agences', 'HomeController@agences')->name('agences');

Route::get('/propos', 'HomeController@propos')->name('propos');
...
//emails
Route::post('/contact-professionnels', 'ContactController@professionnelsEmail')->name('contact.professionnels');
Route::post('/contact-devis', 'ContactController@devisEmail')->name('contact.devis');
Route::post('/contact-thematic', 'ContactController@thematicEmail')->name('contact.thematic');
...
Route::get('cartes/{id?}', 'ThematicController@index')->name('front.cartes.index');
Route::get('cartes/thematic/{id}', 'ThematicController@thematic')->name('front.cartes.thematic');
Route::get('cartes/thematic-devis', 'ThematicController@devis')->name('front.cartes.thematicDevis');
Route::get('cartes/thematic/inspiration/{id}', 'ThematicController@inspiration')->name('front.cartes.inspiration');

Route::get('blog-articles', 'BlogController@index')->name('front.blog.index');

Route::get('blog/article/{id}', 'BlogController@article')->name('front.blog.article');
...
Route::post('/JB-bookingContrat', 'HotelController@confirmBooking')->name('front.hotel.booking');
...
Route::get('getAvailableRoom/', 'PackageController@getAvailableRoom')->name('front.package.getAvailableRoom');
...
Route::post('customer-forgetPassword', 'Auth\CustomerLoginController@postEmail')->name('customer.postEmail');
Route::get('customer-varifyEmail','Auth\CustomerLoginController@varifyemail');
...
//mon compte
Route::get('mon-compte', 'HomeController@moncompte')->name('front.mon.compte');
Route::get('new-compte', 'HomeController@newcompte')->name('front.new.compte');
Route::get('qui', 'HomeController@newcompte')->name('front.new.compte');
Route::get('reset', 'HomeController@resetPwd')->name('front.reset.pwd');
...
Route::get('cities', function (Request $request) {
    ...
    $token = config('services.places');
    $url = "${base}${value}.json?access_token=${token}&types=place&language=fr";
